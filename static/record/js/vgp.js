...
let infoTranslations = {
    en: [
        { 'What is Panel Search?': 'Panel Search is a publicly-available database that allows you to search and utilize Virtual Gene Panels associated with 9,998 human diseases. Virtual Gene Panels can be used for efficient clinical interpretation of genome sequences.' },
    ...
    ko: [
        { 'Panel Search란?': 'Panel Search는 인간의 9,998 질환과 관련된 Virtual Gene Panel을 검색하고 활용할 수 있는 공개 데이터베이스 입니다.Virtual Gene Panel은 게놈 배열의 효율적인 임상적 해석에 도움이 될 수 있습니다.' },
