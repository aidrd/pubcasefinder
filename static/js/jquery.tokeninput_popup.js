...
*/
  ...
  var methods = {
      init: function(url_or_data_or_function, options) {
          ...
          return this.each(function () {
              ...
              $(this).data("tokenInputObject", new $.TokenListPopup(this, url_or_data_or_function, settings));
          });
      },
      clear: function() {
  ...
  $.fn.tokenInputPopup = function (method) {
  ...
  $.TokenListPopup = function (input, url_or_data, settings) {
      //
      // Initialization
      //
      var jqxhr;
