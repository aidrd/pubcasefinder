;(function ($) {
    ...
    const //URL_GET_ALL_PANEL_ID           = 'https://pubcasefinder.dbcls.jp/sparqlist/api/pcf_get_all_panel',
          ...
          URL_GET_PANEL_ID_BY_GENE       = '/pcf_panel_get_mondo_id_match_gene_symbol_synonym_ncbiid',
    ...
    $.VisualGenePanelList = function (root_panel) {
        ...
        function _construct_cache_key(settings){
            ...
            cache_key = cache_key + 'sort=' + settings[SETTINGS_KEY_SORT_TARGET]+'&';
            cache_key = cache_key + 'dir=' + settings[SETTINGS_KEY_SORT_DIRECTION]+'&';
            return cache_key;
        }
